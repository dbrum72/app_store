                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-lg-4 mb-2">
                        <div class="form-floating">
                            ...
                            <div v-if="errors.cnpj_cpf" id="clientCnpjCpfFeedback" class="invalid-feedback text-start">
                                {{ errors.cnpj_cpf[0] }}
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-lg-3 mb-2">
                        <div class="form-floating">
                            ...
                            <div v-if="errors.celphone" id="clientCelphoneFeedback" class="invalid-feedback text-start">
                                {{ errors.celphone[0] }}
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-floating">
                            <div class="form-check text-start">
                                <input type="checkbox" class="form-check-input" id="flexCheckDefault" false-value="0"
                                    true-value="1" v-model="client.whatsapp">
